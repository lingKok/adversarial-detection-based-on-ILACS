...
from RawModels.Utils.dataset import get_fsmnist_train_validate_loader, get_fsmnist_test_loader
...
def main(args):
    ...
    train_loader, valid_loader = get_fsmnist_train_validate_loader(
        dir_name='./FSMNIST/FSMNIST/',
        batch_size=MNIST_Training_Parameters['batch_size'],
        valid_size=0.1,
        shuffle=True)
    test_loader = get_fsmnist_test_loader(
        dir_name='./FSMNIST/FSMNIST/',
        batch_size=MNIST_Training_Parameters['batch_size'])
    ...
    # Training
    best_val_acc = None
    model_saver = '../RawModels/FSMNIST/model/FSMNIST_' + 'raw' + '.pt'
    # print('load orignal model parameters')
    # mnist_model.load(path=model_saver, device=device)
