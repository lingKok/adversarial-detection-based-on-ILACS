...
class ResNet_SVHN(BasicModule):
    def __init__(self, block, layers, num_classes=10, thermometer=False, level=1):
        ...
        self.fc0 = nn.Linear(16 * 32 * 32, 1024)
...
def resnet20_SVHN(thermometer=False, level=1):
    model = ResNet_SVHN(BasicBlock, [3, 3, 3], thermometer=thermometer, level=level)
    return model
